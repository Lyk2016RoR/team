...
Book.create(name:'Kürk Mantolu Madonna', category_id: 3, description:"Her gün, daima öğleden sonra oraya gidiyor, koridorlardaki resimlere bakıyormuş gibi ağır ağır, fakat büyük bir sabırsızlıkla asıl hedefine varmak isteyen adımlarımı zorla zapt ederek geziniyor.",ISBN: "45679750835605", publisher:"Yapı Kredi Yayınları",summary:"Sabahattin Ali, bu kitabında güçlü bir tutkunun resmini çiziyor. ")
