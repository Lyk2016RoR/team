...
Book.create(name:'Kırmızı Saçlı Kadın', category_id: 2, description:"Orhan Pamuk, Yapı Kredi Yayınlarından çıkan yeni romanı.", ISBN: "9789750835605", author:"Orhan Pamuk", publisher:"Yapı Kredi Yayınları" , summary:"Kırmızı Saçlı Kadın'da bizi otuz yıl önce İstanbul yakınlarındaki bir kasabada liseli bir gencin yaşadığı sarsıcı bir aşk hikâyesiyle, büyük bir insani suçun peşinden sürüklüyor.")
Book.create(name:'Senden Sonra Ben', category_id: 2, description: 'Hikâyelerin mutlu sonla bitmesi için yola devam etmek gerekir.', ISBN: "9789750836545605", author:"Jojo Moyes", publisher:"Pegasus" , summary:"Beni o kadar da sık düşünme.
